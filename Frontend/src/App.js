    ...
    >
      <Layout className={`app-container ${currentTheme === 'dark' ? 'dark-mode' : ''}`}>
        ...
        <Content className="app-content">
          ...
          <Row gutter={[24, 24]}>
            ...
            <Col xs={24} lg={16} xl={17}>
              ...
              >
                {!latestRunId && forecastData.length === 0 && !historicalData?.dates?.length ? (
                  <WelcomeCard
                    selectedTicker={config.selectedTicker}
                    selectedModelType={config.selectedModelType}
                  />
        ...
        <Footer className="app-footer">
          StockTime Predictor v1.0 ©{new Date().getFullYear()} · React + Ant Design + FastAPI · 
          <a href="https://github.com/dapuentes/StockTimePredictor" target="_blank" rel="noopener noreferrer">
            GitHub
          </a>
        </Footer>
